...
//        LogUtil.i("Get请求的url==\n" + lastUrl);
        ...
        GsonRequest gsonRequest = new GsonRequest(lastUrl, clazz, new Response.Listener() {
            ...
            public void onResponse(Object o) {
                if (responseCallBack !=null){
                    responseCallBack.httpResponse(RESPONSE_SUCCESS_CODE,o);
                }
            }
        }, new Response.ErrorListener() {
            @Override
    ...
    public static void getDataByPost(final Context context, String reqTag, String url,
                                     final Map<String, String> params, final HRCallBack responseCallBack, int resultCode) {
...
//                LogUtil.i("响应====\n" + jsonObject.toString());
    ...
    public static void getObjectByPost(final Context context, String reqTag, String url,
                                       final Map<String, String> params, final HRCallBack responseCallBack, int resultCode,Class clazz){
        GsonRequest gsonRequest = new GsonRequest(Request.Method.POST, url, clazz, new Response.Listener() {
            @Override
            public void onResponse(Object o) {
                if (responseCallBack !=null){
                    responseCallBack.httpResponse(RESPONSE_SUCCESS_CODE,o);
